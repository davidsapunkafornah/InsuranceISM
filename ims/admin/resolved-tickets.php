...
<html lang="en">
 ...
 <meta name="description" content="Insurance Management System in PHP and MySQL">
    ...
    <title>Insurance Management System | Resolve Benefit Ticket History</title>
...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8">Resolve Benefit Ticket History!</h2>
        </div>
     ...
     <div class="az-content">
      <div class="container">
        <div class="az-content-body">
          ...
          <div class="az-content-label mg-b-5">Resolve Benefit Ticket History Details</div>
