...
<html lang="en">
 ...
 <meta name="description" content="Insurance Management System in PHP and MySQL">
    <meta name="author" content="David Sapunka">

    <title>Insurance Management System |  Add Benefit Category</title>
...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8">Add Insurance Benefit Category !</h2>
        </div>
