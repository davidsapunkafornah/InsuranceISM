...
<html lang="en">
  <head>
    ...
    <title>Insurance ISM Dashboard</title>
...
?>                
                  ...
                  <span>Listed Categories of Benefits</span>
                </div>
              </div>
              <div class="chart-wrapper">
...
?>
                  ...
                  <span>Total Approved Benefits Holder</span>
                </div>
              </div>
              <div class="chart-wrapper">
                <div id="flotChart2" class="flot-chart"></div>
...
?>
                  ...
                  <span>Total DisApproved Benefits Holder</span>
                </div>
              </div>
              <div class="chart-wrapper">
                <div id="flotChart3" class="flot-chart"></div>
...
?>                
                  ...
                  <span>Total Benefits Waiting for approval</span>
                </div>
              </div>
              <div class="chart-wrapper">
                <div id="flotChart4" class="flot-chart"></div>
