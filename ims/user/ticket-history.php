...
<html lang="en">
 ...
 <meta name="description" content="Insurance Management System in PHP and MySQL">
    ...
    <title>Insurance Management System |  Benefit History</title>
...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8">Benefit History!</h2>
        </div>
     ...
     <div class="az-content">
      <div class="container">
        <div class="az-content-body">
          ...
          <div class="az-content-label mg-b-5">Benefit History Details</div>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="ticket-view.php?ticid=<?php echo $row['ID'];?>">View Benefit Detail</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
